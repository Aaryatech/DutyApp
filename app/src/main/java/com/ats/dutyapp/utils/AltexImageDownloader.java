...
import static com.ats.dutyapp.constant.Constants.FOLDER_NAME;
...
public class AltexImageDownloader {
        ...
        new AsyncTask<Void, Integer, Bitmap>() {
            ...
            protected void onPostExecute(Bitmap result) {
                if (result == null) {
                    ...
                    Log.e("DOWNLOAD : ", "          download complete, " + result.getByteCount() +
                            " bytes transferred");
    ...
    private static Uri getDownloadDestination(String downloadSubpath) {
        ...
        File picturesFolder = new File(Environment.getExternalStorageDirectory() + File.separator, FOLDER_NAME);
     ...
     * @since 1.1
     */
    public static void readFromDiskAsync(@NonNull File imageFile,
