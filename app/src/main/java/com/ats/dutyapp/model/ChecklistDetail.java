...
public class ChecklistDetail {
    ...
    public ChecklistDetail(int checklistDetailId, int checklistHeaderId, String checklist_desc, int isPhoto, int isUsed, int delStatus, int createdBy, String createdDate, Integer exInt1, Integer exInt2, String exVar1, String exVar2) {
