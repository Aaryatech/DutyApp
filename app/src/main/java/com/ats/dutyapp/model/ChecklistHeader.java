...
public class ChecklistHeader {
    ...
    public ChecklistHeader(int checklistHeaderId, int deptId, String checklistName, int isUsed, int delStatus, int createdBy, String createdDate, Integer exInt1, Integer exInt2, Integer exInt3, String exVar1, String exVar2, String exVar3, List<ChecklistDetail> checklistDetail) {
