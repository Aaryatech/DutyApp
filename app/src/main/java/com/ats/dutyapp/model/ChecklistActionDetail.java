...
public class ChecklistActionDetail {
    ...
    public ChecklistActionDetail(int actionDetailId, int actionHeaderId, int checklistMasterHeaderId, int checklistMasterDetailId, String checklist_desc, int isPhoto, int checkStatus, String actionPhoto, String closedPhoto, String checkDate, int delStatus, Integer exInt1, Integer exInt2, String exVar1, String exVar2) {
